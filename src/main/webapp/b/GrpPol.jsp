...
<div class="container" style="position:relative;">
    <div class="row">
        <div class="col-xs-10">
            <div class="panel">
                <div class="panel-heading">团险险种信息</div>
                            ...
                            <s:if test="list.size>0">
                                <s:iterator value="list" var="pol">
                                    <tr class="active">
                                        ...
                                        <td><input readonly name="<s:property value="#pol.grpPolNo"/>" value="<s:property value="#pol.grpPolNo"/>"></td>
                                            <%--险种编号--%>
                                        ...
                                        <td><input name="<s:property value="#pol.expAmnt"/>" value="<s:property value="#pol.expAmnt"/>"></td>
                                            <%--预计保费--%>
                                        <td style="width: 50px">
                                            <button style="width: 50px" name="<s:property value="#pol.grpPolNo"/>" class="btn btn-danger" type="button">删除</button>
                                        </td>
                                        <td style="width: 50px">
                                            <a style="width: 50px" name="<s:property value="#pol.grpPolNo"/>" class="btn btn-warning" type="button">修改</a>
                                        </td>
                                    </tr>
                                </s:iterator>
                                <tr>
                                    <td></td>
                                    <td>
                                        <input class="form-control" id="grpPolNo" placeholder=""><%--险种编号--%>
                                    </td>
                                    <td>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".active td button").on("click", function () {//删除
            $.ajax({
                url: "GrpPol_delete.action",
                type: "post",
                data: {
                    lcgrppolid: $(this).attr("name")
                },
        ...
        $("#souye1").click(function () {//首页
            ...
            var url = "GrpPol_findAll.action?currPage=" + page.dataset.page;
            $.ajax({
                url: url,
                type: "post",
                data: {},
