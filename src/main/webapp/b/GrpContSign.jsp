    ...
    <div id="benefit">
        ...
        <div class="row" style="margin: 10px">
            <div class="col-sm-4">
                <div class="input-group">
                    ...
                    <input readonly type="text" id="payMode1" class="form-control" value="<s:property value="lcgrpcont.payMode"/>" placeholder="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon">应缴保费</span>
                    <input readonly type="text" id="prem" value="<s:property value="lcgrpcont.prem"/>" class="form-control" placeholder="">
                </div>
            </div>
            <div class="col-sm-4">
                <div class="input-group">
                    <span class="input-group-addon">实缴费</span>
                    <input readonly type="text" id="payflag" value="<s:property value="lcgrpcont.appntNo"/>" class="form-control" placeholder="">
        ...
        <div class="row" style="margin: 10px">
            <div class="col-sm-6 col-sm-offset-3">
                <button style="position: relative;width: 300px;" id="signsubmit" type="button" class="btn btn-primary">提交</button>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#signsubmit").click(function () {
            $.ajax({
                url: "LCGrpCont_grpSignSubmit.action",
                type: "post",
                data: {
                    contno:$("#contno").val(),
                },
