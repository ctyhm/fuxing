...
<div class="container" style="position:relative;">
    <div class="row">
        <div class="col-xs-10">
            <div class="panel">
                <div class="panel-heading">团险待核保信息</div>
                            ...
                            <s:iterator value="contlist" var="cont">
                                <tr class="active">
                                    ...
                                    <td><input name="<s:property value="#cont.grpName"/>" value="<s:property value="#cont.grpName"/>"></td>
                                        <%--投保人--%>
                                    <td><input name="<s:property value="#cont.prem"/>" value="<s:property value="#cont.prem"/>"></td>
                                        <%--应付--%>
                                    <td><input name="<s:property value="#cont.appntNo"/>" value="<s:property value="#cont.appntNo"/>"></td>
                                        <%--实付--%>
                                    <td><input name="<s:property value="#cont.inputOperator"/>" value="<s:property value="#cont.inputOperator"/>"></td>
                                        <%--录单人--%>
                                    <td style="width: 50px">
                                        <button style="width: 50px" name="<s:property value="#cont.grpContNo"/>" class="btn btn-success" type="button">确认</button>
                                    </td>
                                </tr>
                            </s:iterator>
                        </s:if>
...
<script type="text/javascript">
    $(document).ready(function () {
        $(".active td button").on("click", function () {//确认
            $.ajax({
                url: "LCGrpCont_GrpPaysubmit.action",
                type: "post",
                data: {
