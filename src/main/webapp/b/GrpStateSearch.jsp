        ...
        <div id="res" class="col-xs-8">
            ...
            <table style="position: relative;left: 200px;width: 400px;" class="table table-bordered">
                ...
                <s:if test="lcgrpcont.grpContNo!=null">
                    <tr class="danger">
                        <td style="width: 300px"><input readonly class="form-control" value="<s:property value="lcgrpcont.grpContNo"/>"></td>
                        <td><input readonly class="form-control" value="<s:property value="lcgrpcont.remark"/>"></td>
                    </tr>
                </s:if>
            </table>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#searchcont").click(function () {
            $.ajax({
                url: "LCGrpCont_searchState.action",
                type: "post",
                data: {
                    contno: $("#contno").val()
                },
