...
<div class="container" style="position:relative;">
    <div class="row">
        <div class="col-xs-10">
            <div class="panel">
                <div class="panel-heading">个险待核保信息</div>
                                ...
                                <s:iterator value="contlist" var="cont">
                                    <tr class="active">
                                        ...
                                        <td><input name="<s:property value="#cont.appntNo"/>" value="<s:property value="#cont.appntNo"/>"></td>
                                            <%--实付--%>
                                        <td style="width: 50px">
                                            <button style="width: 50px" name="<s:property value="#cont.contNo"/>" class="btn btn-success" type="button">确认</button>
                                        </td>
                                    </tr>
                                </s:iterator>
                            </s:if>
