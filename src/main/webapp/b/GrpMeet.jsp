...
<div class="container" style="position:relative;">
    <div class="row">
        <div class="col-xs-10">
            <div class="panel">
                <div class="panel-heading">团险预约信息</div>
                            ...
                            <s:if test="list.size>0">
                                <s:iterator value="list" var="meet">
                                    <tr class="active">
                                        ...
                                        <td><input style="width: 50px" readonly name="<s:property value="#meet.grpmid"/>" value="<s:property value="#meet.grpmid"/>"></td>
                                            <%--预约号--%>
                                        <td><input name="<s:property value="#meet.lpname"/>" value="<s:property value="#meet.lpname"/>"></td>
                                            <%--投保人--%>
                                        <td><input name="<s:property value="#meet.compname"/>" value="<s:property value="#meet.compname"/>"></td>
                                            <%--被保人--%>
                                        <td><input name="<s:property value="#meet.comcode"/>" value="<s:property value="#meet.comcode"/>"></td>
                                            <%--机构编码--%>
                                        <td><input name="<s:property value="#meet.grpPolNo"/>" value="<s:property value="#meet.grpPolNo"/>"></td>
                                            <%--险种编码--%>
                                        ...
                                        <td><input name="<s:property value="#meet.phone"/>" value="<s:property value="#meet.phone"/>"></td>
                                            <%--电话--%>
                                        <td style="width: 50px">
                                            <button style="width: 50px" name="<s:property value="#meet.grpmid"/>" class="btn btn-danger" type="button">删除</button>
                                        </td>
                                        <td style="width: 50px">
                                            <a style="width: 50px" name="<s:property value="#meet.grpmid"/>" class="btn btn-warning" type="button">修改</a>
                                        </td>
                                    </tr>
                                </s:iterator>
                            </s:if>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#souye1").click(function () {//首页
            ...
            var url = "GrpMeet_findAll.action?currPage=" + page.dataset.page;
            $.ajax({
                url: url,
                type: "post",
                data: {},
