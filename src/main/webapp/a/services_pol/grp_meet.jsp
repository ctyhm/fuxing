        ...
        <div class="row">
            <div class="col-xs-8 col-xs-offset-2">
                <div class="panel panel-primary">
                    <div class="panel-heading">团险投保预约</div>
                    <div class="panel-body">
                        <div class="col-xs-8 col-xs-offset-2">
                            ...
                            <div class="form-label-group">
                                <label>网点</label><%--下拉选框--%>
                                <a id="ldcomfind" aria-label="Next">
