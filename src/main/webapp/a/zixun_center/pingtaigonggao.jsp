...
<div class="main">
    <div class="container">
        <div class="main_top"><span>当前位置：</span>
            <ul>
                <li><a href='../Home.jsp'>主页</a> > <a href='home-zx.jsp'>资讯中心</a> > <a
                        href='pingtaigonggao.jsp'>平台公告</a> >
                </li>
            </ul>
            <div class="span2"></div>
        </div>
                ...
                <div class="left_con">
                    <div class="type_list">
                        <ul>
                            ...
                            <li class="first_cat"><a class='current' href='pingtaigonggao.jsp' title='平台公告'>平台公告</a></li>
                        </ul>
                    </div>
                </div>
            </div>
