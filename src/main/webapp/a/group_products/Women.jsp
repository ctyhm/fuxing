...
<div class="main">
    <div class="container">
        <div class="main_top"><span>当前位置：</span>
            <ul>
                <li><a href='../Home.jsp'>主页</a> > <a href='home.jsp'>团险产品</a> > <a href='Women.jsp'>团险疾病险</a></li>
            </ul>
        </div>
        <div id="left">
            <div class="left_list">
                    ...
                    <div class="productList">
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img" style="background-image:url(../uploads/allimg/171220/1-1G2201522470-L.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='Women_details.jsp'>团体女性疾病保险</a></h3>
                                    <h4>保费低、高保障...</h4>
                                </div>
                            </div>
                        </div>
