...
<div class="main">
    <div class="container">
        <div class="main_top"><span>当前位置：</span>
            <ul>
                <li><a href='../Home.jsp'>主页</a> > <a href='home.jsp'>团险产品</a> > <a href='Travel.jsp'>团险意外险</a></li>
            </ul>
            <div class="span2"></div>
        </div>
        <div id="left">
            <div class="left_list">
                ...
                <div class="left_con">
                    <div class="type_list">
                        <ul>
                            <li class="first_cat"><a href='Travel.jsp' title='团险意外险'>团险意外险</a></li>
                ...
                <div class="row">
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img" style="background-image:url(../skin/images/grp_travel.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='Travel_details.jsp'>团体旅游险</a></h3>
                                    <h4>保障全面、价格更低...</h4>
                                </div>
                            </div>
                        </div>
