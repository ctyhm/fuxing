            ...
            <div class="main_top"><span>当前位置：</span>
                <ul>
                    <li>
                        ...
                        <a href='a/services_pol/home-pol.jsp'>自助服务</a>
                    </li>
                </ul>
            </div>
            <div id="left">
                <div class="left_list">
                    ...
                    <div class="left_con">
                        <div class="type_list">
                            <ul>
                                <li class='first_cat'><a id="com">网点查询</a></li>
                                <li class="first_cat"><a id="salesman">业务员查询</a></li>
                                <li class="first_cat"><a id="cont">保单查询</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#salesman").click(function () {
            $.ajax({
                url: "Salesman_asearchcomein.action",
                type: "post",
                data: {},
                success: function (result) {
                    $("#right_con").html(result);
        ...
        $("#cont").click(function () {
            $.ajax({
                url: "LCCont_asearchcomein.action",
                type: "post",
                data: {},
                success: function (result) {
                    $("#right_con").html(result);
