...
<div class="main">
    <div class="container">
        <div class="main_top"><span>当前位置：</span>
            <ul>
                <li><a href='../Home.jsp'>主页</a> > <a href='home.jsp'>个险产品</a> ></li>
            </ul>
            <div class="span2"></div>
        </div>
        <div id="left">
                ...
                <div class="row">
                    <div class="productList">
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img"
                                     style="background-image:url(../uploads/allimg/171220/1-1G220163S80-L.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='wealth_details.jsp'>财富年金保险</a></h3>
                                    <h4>保费低、高保障...</h4>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img"
                                     style="background-image:url(../uploads/allimg/171220/1-1G2201520400-L.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='health_details.jsp'>优选重疾险</a></h3>
                                    <h4>住院、门诊全报销...</h4>
                                </div>
                            </div>
                        </div>
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img"
                                     style="background-image:url(../uploads/allimg/171220/1-1G220151Z50-L.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='accident_details.jsp'>意外险</a></h3>
                                    <h4>保障全面、价格更低...</h4>
                                </div>
                            </div>
                        </div>
                        <div class="pro_list wow fadeInUp" data-wow-delay=".2s">
                            <div class="pro_item pro_list2">
                                <div class="pro_item_img"
                                     style="background-image:url(../uploads/allimg/171220/1-1G220151R20-L.jpg);"></div>
                                <div class="pro_item_title">
                                    <h3><a href='travel_details.jsp'>旅游险</a></h3>
                                    <h4>高额身价、随心出行...</h4>
                                </div>
                            </div>
                        </div>
