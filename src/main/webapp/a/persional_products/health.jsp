...
<div class="main">
    <div class="container">
        <div class="main_top"><span>当前位置：</span>
            <ul>
                <li><a href='../Home.jsp'>主页</a> > <a href='home.jsp'>个险产品</a> ><a href='health.jsp'>健康险</a></li>
            </ul>
            <div class="span2"></div>
        </div>
        <div id="left">
                ...
                <div class="left_con">
                    <div class="type_list">
                        <ul>
                            ...
                            <li class="first_cat"><a class="current" href='health.jsp' title='健康'>健康险</a></li>
